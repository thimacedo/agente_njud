...
PROJECT_ROOT = Path(r"F:\Projetos\DIVISOR")
RAW_ROOT = PROJECT_ROOT / "JORNAIS"
PROCESSED_ROOT = PROJECT_ROOT / "data" / "processed" / "JORNAIS_DIVIDIDOS"
OUTPUT_ROOT = PROJECT_ROOT / "data" / "output"
LOG_DIR = OUTPUT_ROOT / "_logs"
ASSETS_DIR = PROJECT_ROOT / "assets" / "vinhetas"
PLAN_CSV = PROJECT_ROOT / "data" / "plano_alocacao.csv"
NJUDS_POR_MES_CSV = PROJECT_ROOT / "data" / "njuds_por_mes.csv"
