...
Uso:
    from src.gravador_inteligente.pipeline import PipelineBoletins
...
from src.gravador_inteligente.tratamento_audio import TratamentoConfig, process as processar_audio
from src.gravador_inteligente.edicao_boletins import EdicaoConfig, editar_boletim
from src.gravador_inteligente.montagem_boletins import MontagemConfig, AssetsConfig, montar_boletim
from src.gravador_inteligente.segmentacao_boletins import SegmentacaoConfig, segmentar_audio
