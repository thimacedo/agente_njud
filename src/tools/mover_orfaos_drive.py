...
DRIVE_ROOT = Path(settings.DIR_DRIVE_JORNAIS)

import csv
import shutil
from datetime import datetime

RELATORIO = Path(settings.DIR_OUTPUT) / "_logs" / "relatorio_orfaos_drive.csv"
PASTA_ARQUIVO_MORTO = DRIVE_ROOT / "_arquivo_morto"
LOG_ARQUIVO_MORTO = Path(settings.LOGS_DIR) / "mover_orfaos_drive.log"
