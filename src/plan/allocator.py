...
REPORT_CSV = settings.BASE_DIR / "data" / "alocacao_boletins.csv"
...
def main() -> None:
    ...
    parser.add_argument("--out-plan", type=str, default=str(settings.BASE_DIR / "data/plano_copia.json"), help="Saída do plano JSON")
    parser.add_argument("--exec-plan", type=str, default=None, help="Executa cópias a partir de um plano JSON")
    parser.add_argument("--workspace", type=str, default=str(settings.BASE_DIR / "data/workspace_temp"), help="Workspace temporário")
