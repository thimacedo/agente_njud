...
Motivo: Script ad-hoc escopado para JORNAIS/AGOSTO/, um lote histórico
específico já concluído.

Original arquivado em .trash/2026-09-14_deprecados_orquestradores/processor_v3.py
para referência histórica. Ver ARQUITETURA_ALVO_2026-09-14.md, seção 1.1.
"""
import sys

print(
    "\n[DEPRECADO] processor_v3.py não é mais o caminho canônico de execução.\n"
    "Use: run_dispatcher.sh (src/pipeline/dispatcher.py)\n"
    "Motivo: Script ad-hoc escopado para JORNAIS/AGOSTO/, um lote histórico "
    "específico já concluído.\n"
