...
│   │   ├── safe_runner.py       # execução segura do pipeline (dry-run/apply)
│   │   ├── intelligent.py       # orquestrador inteligente de lotes
...
- Wrappers de compatibilidade da raiz removidos em 2026-08-31 (saneamento P5)
